...
// find  alphamle, betapmle, betamle
{
	...
	if (output) {
		Rcout << endl << "  Maximum likelihood estimates of parameters:" << endl << endl;
		if (model==M1) {
			Rcout << setw(19) <<  "changepoint's" << setw(15) << "slope of" << 
				setw(14) << "slope of" << endl;
			Rcout << setw(10) << "x coord." << setw(10) << "y coord." << setw(14) << "first line" << 
				setw(14) << "second line" << setw(12) << "variance" << endl;
			Rcout << setw(10) << "(theta)" << setw(10) << "(alpha)" << setw(15) << "(beta-prime)" << 
				setw(13) << "(beta)" << setw(11) << "(var)" << endl << endl;
			Rcout << setw(9) << thmle << setw(10) << alphamle << setw(14) << betapmle << 
				setw(14) << betamle << setw(12) << vmle << endl << endl;
		}  else  {
			Rcout << setw(19) <<  "changepoint's" << 
				setw(15) << "slope of" << endl;
			Rcout << setw(10) << "x coord." << setw(10) << "y coord." <<  
				setw(14) << "second line" << setw(12) << "variance" << endl;
			Rcout << setw(10) << "(theta)" << setw(10) << "(alpha)" <<  
				setw(14) << "(beta)" << setw(11) << "(var)" << endl << endl;
			Rcout << setw(9) << thmle << setw(10) << alphamle <<  
				setw(14) << betamle << setw(12) << vmle << endl << endl;
		}
		Rcout << endl;
	}
