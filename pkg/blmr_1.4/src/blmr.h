...
//in file rho_etc:
	...
	double rho_inv(double s, int k, int hi_lo =1);
...
public:
// constructors
	Cblmr(NumericVector Xda, NumericVector Yda, int model =1, bool var_known =false);
	Cblmr(NumericVector Xda, NumericVector Yda, NumericMatrix S, int model =1, bool var_known =false);
	~Cblmr();		// destructor
